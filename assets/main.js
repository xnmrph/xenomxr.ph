...
(function() {
	...
	// Initialize "On Visible" animations.
		onvisible.add('#header', { style: 'fade-in', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#video01', { style: 'fade-in', speed: 1500, intensity: 5, threshold: 3, delay: 0, replay: false });
